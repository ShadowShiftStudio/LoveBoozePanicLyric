...
label _day5 :
    ...
    "К сожалению, Юли все ещё не было видно. "
    ...
    if day5_nadya_in_cafe :
        ...
        if day5_nadya_date :
            ...
            menu :
                ...
                "Пойти к себе в комнату" :
                    ...
                    "Она удалилась в свою комнату, я же пошел в свою. "
            ...
            extend "В данной ситуации он был совершенно неожиданным."
            ...
            # концовка
                ...
                extend "Как только на тебя обратило внимание парочка шлюх, так все? "
        ...
        "Но дальше у нас разговор не пошел - было время процедур."
        ...
        "Надев свои лучшие шмотки, я пригладил волосы, подмигнул себе в зеркало и пошел блатной походкой в назначенное место встречи."
        ...
        if day5_go_look_for_emilia :
            ...
            if day5_kiss_emilia :
                ...
                extend "Цвет ее лица слился с цветом волос, а широко раскрытые глаза, кажется, неверяще смотрели на меня."
                
                
                "Вот между нашими лицами осталась пара сантиметров, я уже почувствовал ее теплое дыхание на своих губах."
                ...
                if day5_help_emily_panic :
                    ...
                    "Я попытался придвинуться еще ближе, но Эмилия, укуталась сильнее. "
                    ...
                    "Еще через пару минут, она раскуталась и равнодушно посмотрела на меня."
                    ...
                    extend "Так что перевернувшись на бок, я просто закрыл глаза и уснул. "
                    extend "Прямо в одежде. "
                    stop music fadeout 1.0
                    extend "День - дерьмо..."
                    jump _day6
                else :
