...
label first_day:
    ...
    play music "audio/bad_dream.mp3" volume 0.4 fadein 10.0
    ...
    "Раньше я был гораздо ответственнее и давал отчёт своим поступкам." 
    ...
    "О боже, она слегка посмеялась. Ей понравилась моя дурацкая шутка!"
...
label second_day :
    ...
    if int(_return) > int(hi_score):
        ...
        "что он может возродиться, обрести новую жизнь и расцвести, словно редкая красочная картина, привлекающая взгляды и восхищение"
    else:
    ...
    if day2_sanya_went_to_smoke :
        ...
        if day2_nadya_bought_sigaretts :
            ...
            sanya "пойдём, мне всё равно нечем заняться."
        ...
        if day2_nadya_bought_sigaretts or day2_nadya_get_one_sigarett :
            ...
            nadya "Вот буквально сегодня, кстати, ходила в деканат подавать документы на поездку в санаторий от нашего ВУЗа."
            "Ничего себе, я ж тоже туда еду!"

            show nadya flirting
            with dissolve

            nadya "Мне кажется, или я тебя там тоже видела?"
...
label _sanatorium :
    ...
    menu:
        ...
        "Да мы с ним два сапога пара.":
            ...
            $ rel_pavel += 1
            play music "audio/kevin-macleod-hall-of-the-mountain-king.mp3" fadein 2.5 fadeout 3.0 volume 0.15
    ...
    if day4_tried_move == True:
        ...
        "Рядом с пепельницей у стены стояло два весьма удобных, хоть и старых кресла."

        "Никогда не был особым ценителем ландшафтного дизайна, но этот вид и у меня вызывает восторг."

        "Множество клумб и цветов, которые складывались в незамысловатые узоры. Много беседок поодаль, изумрудные поляны и много деревьев."
        ...
        "Плюнув на всё, я плюхнулся в кресло и, любуясь видом, всё-таки достал свой вишнёвый чапман."
        ...
        sanya "Да обычные, вроде. Чапман вишнёвый."
    ...
    menu:
        "Подсяду к Юле":
            ...
            yuli "Не против, пойдём проветримся."
            ...
            if day4_walk_in_park:
                ...
                menu :
                    ...
                    "Мне одиноко. Быть может, она составит мне компанию?" :
                        ...
                        extend "Ты же можешь просто уйти из дома и делать все, что захочешь."
...
label _day5 :
    ...
    if day5_nadya_in_cafe :
        ...
        if day5_nadya_date :
            ...
            play sound "audio/girl_laugh4.mp3" noloop fadein 0.3 fadeout 0.3 volume 2.0
        ...
        emily "Неплохо. "
        extend "Правда, из-за того, что спала с открытым окном, под утро замерзла. "
        ...
        extend "Они иногда на несколько дней затягиваются, так что проиходиться ночевать."
        ...
        emily "Мне не очень нравится дома находится, а родители запрещают квартиру снимать, говорят \"что нам на нее деньги тратить, у тебя есть уже где жить\"."
        ...
        extend "Они уже все за меня продумали. "
        ...
        extend "Родители меня, конечно, не отпустят, но вдруг случиться такое, что получится, было бы очень круто!"
        "Я кивал в такт её словам. "
        extend "Эмилию понесло, видимо у нее давно не было нормальных собеседников. "
        ...
        extend "Глаза Юли заблестели, и я поспешил добавить:"
        sanya "Да все нормально! "
        ...
        "Но дальше у нас разговор не пошёл - было время процедур."
        ...
        if not day5_look_for_yuli :
            ...
            if day5_go_look_for_emilia :
                ...
                if day5_kiss_emilia :
                    ...
                    if day5_help_emily_panic :
                        ...
                        "Поднявшись с пола, я попытался подойти к Эмилии, но у нее случилась настоящая истерика."
                        ...
                        "Но пересилив себя, все-таки смог подойти к сжавшейся в комочек Эмилии."
                        ...
                        "Бля-я-я-я..."
                        "Поднявшись с пола, я попытался подойти к Эмилии, но у нее случилась настоящая истерика. Она металась на кровати, кричала и рыдала. Выглядело это пугающе, а что делать я не знал совершенно."
                        "Я попытался к ней приблизиться, но в меня тут же полетела подушка, а истерика, кажется, усилилась."
                ...
                if day4_with_skin :
                    ...
                    if day5_run_with_skin :
                        ...
                        "Я даже могу начать менять ее к лучшему. Удалить ютуб, вставать чуть раньше."
                        ...
                        skin "Конечно хотелось. И сейчас хочется. Но когда я вижу в зеркале свое тело."
                        ...
                        skin "В твоем вопросе - я не помощник. Никто не помощник. Если ты ищешь мотивации - ищи ее в своей голове, а не голове другого человека. Это чисто стадный инстинкт, когда ты пытаешься подражать другому."
            ...
            "Последние слова она произнесла мне буквально в ухо, обдав их горячим дыханием. По коже пробежали мурашки, и я тут же почувствовал ее руки на своих плечах."
            ...
            "Ее лицо было в паре сантиметров от моего. Ее глаза смотрели нежно и очень добро. Руки мягко гладили мои плечи."
