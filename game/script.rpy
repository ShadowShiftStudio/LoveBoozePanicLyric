...
label first_day:
    ...
    show yuli welcome at center with Fade(4.0, 1.5, 3.5)
    ...
    "Ее присутствие словно дарит ветерок летнего утра, и взгляд на неё вызывает неподдельное восхищение."
    stop music fadeout 5.0
    hide yuli welcome with Fade(3.0, 1.0, 2.0)
...
label second_day :
    ...
    if day2_sanya_went_to_smoke :
        ...
        if day2_sanya_vote_for_ussr:
            ...
            "Каждый удар и пинок приходился как из нескончаемой лавины, заставляя меня чувствовать острые ушибы и жгучую боль." 
        ...
        play music "music/tchaikovsky-Hymn_of_the_Cherubim.mp3" fadein 0.0 fadeout 5.0 volume 0.1
        show nadya welcome at center with Fade(0.0, 0.0, 3.0)
        ...
        "Её рыжеволосые пряди волнились легко, словно играли в танце с ветерком."
    ...
    if not day2_nadya_get_one_sigarett and not day2_nadya_bought_cigarettes and not day2_sanya_went_to_smoke:
        ...
        "Настроение было, мягко говоря, подвешенным."
...
label _sanatorium :
    ...
    "Вот и я, как и эти старые пердуны, незаметно для себя постарел. В их естественной среде обитания комфортно себя чувствую, буду те же процедуры проходить, что и они."
    ...
    menu:
        "А можно мне другого соседа...":
            ...
            $ rel_pavel -= 1
            play music "audio/cherry-metal.mp3" fadein 2.5 fadeout 3.0 volume 0.15
    ...
    if day4_take_pill:
        ...
        if day4_yuli_meal:
            ...
            if day4_walk_in_park:
                ...
                "Хотелось побыть одному, в комнате сто процентов был Павел Геннадьевич, так что выбор на вечернюю прогулку по парку. "
                ...
                menu :
                    ...
                    "Мне одиноко. Быть может, она составит мне компанию?" :
                        ...
                        scene sanatorium evening park with fade
