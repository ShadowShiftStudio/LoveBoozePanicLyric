...
transform cam_shake_once:
    yalign 0.0 xalign 0.0
    block:
        matrixcolor IdentityMatrix()
        linear 0.02 xpos 8 ypos -5
        linear 0.02 xpos -8 ypos 5
        repeat 24
        linear 0.02 xpos 0 ypos 0
...
image bg_day5_room = ConditionSwitch(
    "day4_tried_move and day4_fight", "sanatorium dormitory room",
    "True",                                "sanatorium skin dormitory room")
...
screen emily_welcome():
        add "images/emily/welcome.png" at bg_fullscreen
        add Movie(play="images/video/petals.webm", side_mask=True):
                zoom 2.0
        add "images/emily/welcome_focus.png" at bg_fullscreen
...
label first_day:
    ...
    "*Звук будильника*"
    stop sound
    play sound "audio/alarm-sound-end.mp3" volume 0.2
    ...
    "Рядом со мной сидит удивительно прекрасная девушка, облачённая в откровенную лёгкую майку." 
    ...
    sanya "Занят? Ага, как же. пришёл просто сон утренний досмотреть. А что, хочешь присоединиться к просмотру?.."
    ...
    "*Юля легко проводит рукой по моёму подбородку, поворачивая голову в сторону преподавателя*"
    ...
    if day1_pasha_kfc :
        ...
        pasha "Ну чё, [player_name_buf], идём в кефас?"
        ...
        call play_kfc_minigame(enemy_name="pasha", enemy_image_path="pasha/giggles.png")
        if str(_return) == "pasha":
        ...
        show pasha neutral  at heat_haze(strength=0.005, scale=4.2, speed=0.005, wobble=0.9, temporal=10.88):
            yalign 0.0 xalign 0.5 yoffset -100
            subpixel True
            nearest False
            block:
                ease 4.0 rotate 1
        ...
        pasha "А что такое, нашему Санечке [decline_surname_male(player_name_buf, 'дательный')] тяжёлое курить нельзя?"
        show pasha giggles
        with dissolve
        ...
        if day1_yuli_agreed_after_kfc :
            ...
            "Это временное закрытие длиться уже буквально год!"
            "Пробравшись слева от забора, по ту сторону я увидел Юлю. Она меня сразу заметила и приветливо улыбнулась мне."
        ...
        "После всех мыслей, я не нашёл ничего лучше, чем поехать домой."
...
label second_day :
    ...
    "Подойдя к окну, я достал уже изрядно потрепанную пачку сигарет, но единственное, что я в ней нашёл, – это затхлый запах табака."
    "Пиздец... " 
    ...
    centered "{size=+24}Подберите раскиданные справки за [sec_medical_certificates] секунд.\nНажмите, чтобы начать.{/size}"
    $ hf_bg()
    # запустим игру
    $ hf_start()
    ...
    stop sound fadeout 0.5
    "Уже вечерело, времени ушло куда больше, чем я ожидал. {w}У выхода из корпуса я заметил несколько одногруппников, по разговору было понятно, что они направляются в курилку."
    ...
    if day2_sanya_went_to_smoke :
        ...
        "Порывшись получше в рюкзаке, я пришёл только к одному выводу: я ..."
        ...
        if day2_sanya_vote_for_ussr:
            ...
            sanya "Да так, ничего серьёзного, день с самого утра не задался, не стоит так беспокоиться."
            show yuli happy
            with dissolve
            ...
            yuli "Ого! Я и не знала, что мы так близко живём!"
            ...
            "Мы уже приближались к дому Юли, я был сильно удивлен тем, что мы живём совсем рядом."

            sanya "Я и не знал, что мы живём так близко друг к другу."
    ...
    if not day2_nadya_get_one_sigarett and not day2_nadya_bought_cigarettes and not day2_sanya_went_to_smoke:
        ...
        "Раздевшись и набрав воды я улегся в неё. Голова была совсем пуста, желание думать О чём-то совсем отпало."
        ...
        "Просто хочу уйти от проблем самым кратчайшим путём, даже не попытавшись решить их..."
    ...
    if day3_choice_lonely :
        ...
        menu :
            ...
            "Меньше бы курила, сейчас бы дома отдыхала. Полной грудью дышала бы, ха-ха." :
                $ rel_nadya -= 1
                "Надя обиделась и мне пришлось отсесть. Не думаю, что мы серьёзно поссорились."
                jump _sanatorium
...
label _sanatorium :
    ...
    "Вслед за мной в комнату зашёл мужик. Конкретный такой мужик, будто бы только что вышедший из жесткого запоя. Пахло от него соответствующе."
    ...
    if day4_tried_move == True:
        ...
        valeria "Ну как же это! Павел Геннадьевич очень хороший молодой человек! Культурный, аккуратный, чистоплотный..."
        ...
        if day4_smoke_after_words_valeria :
            ...
            "Он вскочил, причём очень резво, что было неожиданно для его грузной комплекции."
            ...
            "Явно через силу, но Валерия Владимировна всё же произнесла:"
            ...
            skin "Тихо, блядь! ты мешаешь моёму слиянию с бесконечно вечным!"
            ...
            menu :
                "Жестко вспомнить предков" :
                    ...
                    skin "Я когда у бабушки на чердаке убирался, одну книгу нашёл, можно сказать, манускрипт!"
                    extend " Русскими рунами писано было, Родом клянусь! И бумага такая, будто из кожи сделана, ну, ты понимаешь, О чём я..."
                    sanya "Ну как сказать..."
                    skin "Короче, я на один форум зашёл, там мне все и объяснили. Сказали, это древний травник, возможно, созданный ещё при Рюриковичах, представь!"
                    ...
                    "Он вновь протянул мне скрутку, причём с таким одухотворенным лицом, что я просто не смог отказать. Вот так в секты и попадают."
                    sanya "Ну, ладно, давай своё чудодейственное средство."
                    "Он с готовностью сунул мне в руку скрутку, кажется, в сушёном лопухе, и достал зажигалку."
                    ...
                    "По комнате распространился запах горелой травы, но не то, чтобы он неприятно пах. Ободрённый этим фактом, я затянулся. "
                    
                    play sound "audio/pavel_cough.mp3" noloop fadein 0.1 fadeout 0.1
                    window show
                    sanya "Кха-кха-кха-кха!" 
                    "Легкие обожгло огнём, а в голове зашумело. Кашель был настолько сильный, что меня чуть не вырвало. "
                    scene sanatorium skin dormitory room at cover_full, heat_haze(strength=0.035, scale=6.2, speed=0.085, wobble=0.7, temporal=0.08)
                    show skin happy at center, heat_haze(strength=0.015, scale=4.2, speed=0.075, wobble=0.6, temporal=0.08)
                    with dissolve
                    "Дышать я не мог, так что очень скоро начал задыхаться."
                    skin "Ой, я тебе, кажется, не ту дал! Щас, подожди... Где же она..."
                    "Под мой нестерпимый кашель он вновь принялся копаться в своей сумке, и в скором времени извлёк оттуда новую скрутку. "
                    
                    play sound "audio/pavel_cough.mp3" noloop fadein 0.1 fadeout 0.1
                    
                    skin "Держи! Это то, что надо!"
                    scene sanatorium skin dormitory room at cover_full, heat_haze(strength=0.055, scale=9.2, speed=0.095, wobble=0.7, temporal=0.1)
                    show skin happy at center, heat_haze(strength=0.015, scale=4.2, speed=0.175, wobble=0.9, temporal=2.58)
                    with dissolve
                    sanya "И... Иди... Помоги...."
                    ...
                    "Ох-х-х, как же мне хуёво..."
                    "Перед глазами все вертелось и кружилось, а во рту будто бы насрали кошки. причём несколько раз."
                    "Легкие болели так, будто бы их прострелили. Нахуй я согласился?.. Щас бы сидел в столовой, пил чаек с девчонками и в ус не дул."
                    window auto
                    scene firstDays medical at cover_full, heat_haze(strength=0.025, scale=5.2, speed=0.095, wobble=0.7, temporal=0.1)
                    show grusha happy
                    with Fade(0.4, 0.5, 0.4, color="#000")
                    ...
                    sanya "Вы кто? Где я?"
                    grusha "Я Агриппина Филипповна, твой ангел хранитель на случай, если опять будешь принимать сомнительные вещёства."
                    ...
                    scene firstDays medical at cover_full, heat_haze(strength=0.01, scale=2.2, speed=0.015, wobble=0.07, temporal=0.01)
                    show grusha neutral
                    with dissolve
                    "С каждой минутой мне становилось все лучше и лучше. По крайней мере, вертолётики кончились, да и легкие не так сильно болели. "
                    ...
                    show grusha angry
                    camera at cam_shake_once

                    grusha "Ну так иди на хрен отсюда!" 
                    camera 
                    ...
                    scene sanatorium medical post at cover_full
                    with Fade(0.4, 0.5, 0.4, color="#000")
        ...
        "Плюхнувшись на свободное кресло, которое жалобно скрипнуло под ним, но всё же стоически выдержало, он закурил."
        ...
        if day4_drink == True:
            ...
            "По крайней мере, вертолётики кончились, да и живот не так сильно болел."
            "Наконец, я смог нормально осмотреться."
            "Обычный процедурный кабинет. В дальнем углу звенела колбами низенькая женщина, видимо, это и есть Агриппина Филипповна."
    ...
    menu:
        "Подсяду к Юле":
            ...
            "Ей служила отдаленная беседка на живописном берегу реки. На поребриках стояли пепельницы, однако, в них не было ни одного окурка."
    ...
    stop music fadeout 2.0 
    $ neighbour = "скинхед" if day4_tried_move and not day4_fight else "Павел Геннадьевич"
    if day4_take_pill:
        ...
        if day4_yuli_meal:
            ...
            scene sanatorium alcove at bg_fullscreen, purple_ambient
            with Fade(0.2, 0.3, 0.2, color="#000")
            ...
            scene sanatorium at bg_fullscreen, purple_ambient
            with Fade(0.2, 0.3, 0.2, color="#000")
            ...
            if day4_walk_in_park:
                ...
                scene black
                with Fade(0.2, 0.3, 0.2, color="#000")
                $ neighbour = "Мыкало" if day4_tried_move and not day4_fight else "Павел Геннадьевич"
                "Хотелось побыть одному, в комнате сто процентов был [neighbour], так что выбор пал на вечернюю прогулку по парку. "
                extend "Там обычно никого нет, да и созерцание красивых видов успокаивает."
                ...
                "Я ходил настолько громко и угрюмо, что случайно подвернул споткнулся и чуть не упал."
                stop music fadeout 2.0
                ...
                menu :
                    "Красивая... Но настроения нет. Лучше пойду мимо.":
                        ...
                        "Мне льстило, что о моём психическом здоровье кто-то поинтересовался, но слишком уж много девушек за последнее время сделали мне от ворот поворот, не хочется обжигаться снова. "
                        ...
                        if day4_drink:
                            ...
                            pavel "Когда я был в твоем возрасте, после каждой более-менее серьёзной проблемы мне казалось, что жизнь окончена."
                            ...
                            pavel "Не поспоришь."
                            "Помолчали. Каждый думал о своем, смотря на природу."
                            pavel "Когда я был в твоем возрасте, после каждой более-менее серьёзной проблемы мне казалось, что жизнь окончена. Однако стоило немного подумать, приложить усилия, как решение находилось."
                            pavel "И так всю жизнь. Кажется, что жизнь сложна. "
                    ...
                    "Мне одиноко. Быть может, она составит мне компанию?" :
                        ...
                        hide screen emily_welcome
                        scene sanatorium evening park at bg_fullscreen
                        show emily green neutral at purple_ambient, center
                        ...
                        show emily green shy at purple_ambient, center
                        with dissolve
                        ...
                        "моёму удивлению не было предела."
                        ...
                        sanya "Ты серьёзно не ела шаурму?"
                        "моёму удивлению не было предела."
                        ...
                        show emily green neutral at night_ambient, center
                        with dissolve
                ...
                if day4_suicide :
                    ...
                    "Как ни странно, но это придало мне сил. С мрачными мыслями и плохим настроением, я всё же смог уснуть."
                    ...
                    "Я резко отпрянул. Кинул бычок в пепельницу и зашёл в комнату. На кровати похрапывал Павел Геннадьич, и когда только успел войти?"
                    "Раздевшись, я лег в кровать. В груди что-то болело, но я не обращал на это внимания."
                    "Наверное, всё же зря я так. Кто знает, что преподнесет мне следующий день?"
            ...
            nadya "Работать на нелюбимой работе – это какой-то особенный вид мазохизма, помоёму." 
            ...
            "Закончив, она утерла выступившие в уголках глаз слезы и наклонилась чуть ближе к моёму лицу."
        ...
        sanya "Да особенно рассказывать и не О чём..."
...
label _day5 :
    ...
    play sound "audio/typewriter-sound.mp3" volume 0.5 loop fadeout 0.2
    ...
    scene bg_day5_room at bg_fullscreen
    with dissolve

    play sound "audio/snore_big.mp3" noloop fadein 0.2 fadeout 0.3 volume 0.4
        
    "Немного гудела голова, да и глаза слипались, но спать дальше желания не было. Встав с кровати, я протёр веки. На соседней кровати похрапывал [neighbour]."
    ...
    if day5_nadya_in_cafe :
        ...
        "Поставив на стол поднос с едой, я поинтересовался:"
        play sound "audio/chair_crack.mp3" noloop fadein 0.2 fadeout 0.2
        sanya "Как дела?"
        "Девушка прожевала, пронзительно посмотрела на меня и выдала:"
        show nadya laughs
        with dissolve
        nadya "Когда я ем – я глух и нем! "
        extend "Так что извини, я не люблю болтать за столом."
        "С этими словами она закинула себе в рот новую порцию густого молочного супа и принялась активно жевать."
        "Что ж... "
        extend "Справившись с оторопью, я пожал плечами. "
        extend "Мало ли какие у людей причуды бывают."
        "Спокойно продолжил завтракать в тишине, прерываемой лишь постукиванием ложек о тарелки."
        "Только когда на столе осталась полностью пустая посуда, Надя обратила на меня внимание."
        ...
        if rel_yuli >= 3:
            ...
            "Что-то не давало мне покоя, какое-то зудящее чувство на периферии сознания раздражало своим присутствием."
            "Словно я что-то сделал не так, что-то упустил или проигнорировал."
            "Терзаемый непонятным чувством, я переходил с процедуры на процедуру, как вдруг прозвучал знакомый голос, заставивший меня вздрогнуть."
            noname "Саша..."
            ...
            "Обернувшись в поисках голоса, я никого не обнаружил."
            "поёжился, поймав заинтересованный взгляд какого-то взрослого мужика, что проходил мимо моей ванной."
            ...
            extend "По спине пробежали мурашки, а в ванной как будто бы стало в разы холоднее."
            "Погрузившись в воду по шею, я вновь поёжился. "
            extend "Кажется, этим неприятным чувством была вина. "
            extend "Вина за то, что я не поговорил с ней после вчерашнего. " 
            extend "Не нашёл, не написал даже."
            "Ы-ы-х... "
            ...
            "Так! "
            extend "Вскочив из ванной и расплескивая воду я пошлёпал в раздевалку."
            "ещё бы меня совесть Юлиным голосом стыдила. "
            extend "Нафиг, нафиг, пойду подышу, что ли..."
            scene balcony at bg_fullscreen with fade
            ...
            "Но какой-то червячок сомнения грыз меня, наводя на разные мысли. Может, всё-таки, найти Юлю, чтобы нормально спросить в чем дело? А то как то не по-пацански получается..."
        ...
        if day5_nadya_date :
            ...
            "Эх... "
            extend "Кажется, именно этого не хватало в моей серой и бессмысленной жизни..."
            noname "Да что ты!"
            stop music fadeout 0.3
            show screen toska
            play sound "audio/heart.mp3" fadein 1.0 fadeout 2.0 volume 0.8

            "Голову пронзила резкая вспышка боли, причём такой силы, что потемнело в глазах."
            "Покачнувшись, я всё-таки смог устоять на ногах. "
            extend "Однако пульсирующая тяжесть в голове осталась."
            ...
            "Меня подхватили Надины тонкие, но удивительно сильные руки."
            ...
            "Мы сели на скамейку в ближайшей беседке. "
            extend "Головокружение прошло и в глазах немного прояснилось."
            ...
            "На самом деле, мне было совершенно побоку на все эти эпохи Ренессанса, барокко и остальное." 
            "Я просто получал удовольствие смотря на неё, пока она с таким огоньком в глазах говорит О чём-то. "
            ...
            stop music
            "Голову вновь пронзила резкая вспышка боли, которая была даже сильнее, чем предыдущая. "
            ...
            extend "Голова кружилась, боль пульсировала в висках." 
            extend "Подняв взгляд, я с трудом смог его сфокусировать."
            ...
            "Каждый шаг отдавался болью в затылке, но с помощью Нади всё-таки смог кое-как пойти."
            ...
            "В зубы ударился стакан и боль немного взбодрила." 
            extend "С трудом, на я смог проглотить до жути горькую таблетку. "
            ...
            extend "Что-то до снова ужасно горькое. "
            ...
            "всё-таки осень начинала входить в свои права, поэтому после заката температура опускалась достаточно низко."
            ...
            menu :
                "Предложить пойти к Наде." :
                    ...
                    if day4_nadya_meal :
                        ...
                        sanya "На самом деле, я считаю тебя самой красивой девушкой, которая только есть в моём окружении."
                        "Повисла тишина. "
                        ...
                        play voice "audio/girl_laugh3.mp3"
                        extend "Через секунду к моёму смеху присоединилась и Надя."
                        nadya "Если хочешь... "
                        extend "Можешь остаться у меня, соседняя кровать все равно не занята."
                        "Я замер, не веря своим ушам. "
                        extend "Посмотрел на Надю, ожидая увидеть улыбку, но та была серьёзной."
        ...
        if not day5_look_for_yuli :
            ...
            menu:
                ...
                "Перестать бегать за девчонками и поискать яйца":
            ...
            if day5_go_look_for_emilia :
                ...
                emily "Нет-нет! "
                extend "Не уходи!"
                "Она сделала шаг вперед, схватив меня за руку."
                emily "Может... "
                ...
                emily "Секундочку, только сниму уличную одежду."
                "Она исчезла всего на минуту. Я подождал её у двери молча."
                "Через время из-за двери появилась только её рука, схватила меня и понесла внутрь."
                ...
                "Её комната была с большой кроватью и на выглядела обставленной. Видимо, по платной путёвке предоставляют такие апартаменты."
                "Все было чисто и аккуратно, только одежда валялась на стуле, что выбивалась из общей опрятности."
                "Эмилия потянула меня на белую кровать, заставив сесть. "

                show emily home neutral at left:
                    zoom 1.1
                    ypos 1.0
                ...
                "Сама примостилась рядом, всё так же не отпуская рукав моей кофты."
                "Лишь сейчас заметил, как красива ночнушка, в которую она оделась."
                ...
                if day5_kiss_emilia :
                    ...
                    show emily home flirting at center
                    with dissolve
                    ...
                    "причём с такой силой, что я слетел с кровати, больно ударившись об пол."
                    show emily home sad at center
                    ...
                    if day5_help_emily_panic :
                        ...
                        sanya "Что же мне так не везёт на девушек..."

                        play sound "audio/footsteps_loop.mp3" fadein 0.2 fadeout 0.2

                        "Настроение пробило все пределы, так что я просто поплёлся в комнату. На душе было гадко, хотя я, вроде, ничего такого и не сделал. Кажется, у меня судьба такая, быть неудачником. Эх..."
                        stop sound fadeout 0.5
                        pause 0.5
                        ...
                        "Проснувшись утром, я, полностью разбитый, пошёл в ванную, чтобы умыться и почистить зубы."
                        stop music
                        scene bg_day5_room at cover_full, heat_haze(strength=0.015, scale=4.2, speed=0.075, wobble=0.6, temporal=0.08) with fade
                        
                        play sound "audio/scream_dream.mp3" noloop
                        ...
                        play sound "audio/Eeroioe-Industrial-Drone.mp3" noloop volume 0.3
                        scene dream emily at cover_full, tv_noise(strength=0.2, grain_px=1.0, speed=3.0, line_int=0.9, warp=0.002, color=0.50) with fade
                        "Там, в окружении кучи людей, в огромной лужи крови лежала сломанной куклой Эмилия."
                        scene dream emily2 at cover_full, tv_noise(strength=0.3, grain_px=2.0, speed=3.0, line_int=1.0, warp=0.003, color=0.90)
                        "В тот же миг люди, стоящие внизу подняли свои головы. Несмотря на то, что между нами было расстояние в пару этажей, я отчётливо увидел в их глазах презрение, смешанное с осуждением."
                        "Шок не давал двинуться. Я смотрел вниз на Эмилию и не мог поверить своим глазам."
                        "Вдруг она повернула голову и посмотрела прямо на меня."
                        scene black
                        show emily dreamforeground at center, tv_noise(strength=0.0, grain_px=0.1, speed=1.0, line_int=0.2, warp=0.008, color=0.4) 
                        with dissolve
                        ...
                        "Пот покрыл всё тело, горло болело, а сердце бешено колотилось. Вскочив, я подбежал к балкону. Посмотрел вниз. Никого. Облегчение разлилось по телу, и я чуть расслабился. Сон... Всего лишь сон..."

                        jump _day6 
                else :
                    sanya "Я не думаю, что это хорошая идея, учитывая то, что мы знакомы два дня."
                    "Серьёзно, кто вообще предлагает такую близость через два дня общения?"
                    "Хотя, я думаю, для кого-то это покажется нормальным, разные же люди есть. "
                    extend "Но точно не в такой ситуации."
                    ...
                    show emily home neutral at center
                    with dissolve
                    ...
                    emily "Мне не дают денег на карманные расходы и заставляют вести отчёт о каждой трате. "
                    ...
                    emily "Снизится успеваемость – накажут. Начну общаться с кем-то без одобрения – накажут."
                    menu:
                        "Мне кажется, ты преувеличиваешь.":
                            sanya "Серьёзно, звучит все немного... бредово."
                        ...
                        "Это какой-то кошмар...":
                            sanya "У тебя на этой почве разве не проявляются потуги бунтарства?"
                    emily "Конечно, мне хочется сбежать из под их душной опеки, пожить так, как мне хочется. "
                    extend "С тем, с кем мне хочется."
                    show emily green happy with Dissolve(0.2)
                    ...
                    emily "Просто ты выглядел таким хмурым, будто бы у тебя случилось что-то серьёзное."
                    ...
                    sanya "Да все нормально! "
                    extend "Мы же все-равно хотели погулять, а тут считай в гости зашёл, на улице же холодно. "
                    ...
                    extend "Устал я знатно, так сон пришёл быстро. "
                ...
                play sound "audio/pavel_cough.mp3" noloop fadein 0.2 fadeout 0.2
                "Продышавшись, выбросил недокуренную сигарету. Все. Заебло. Пора бы уже бросать эту хуйню. Мне скоро выпускаться, а я ещё даже не знаю кем стать."
                play sound "audio/rustle.mp3" noloop fadein 0.2 fadeout 0.4 volume 0.2
                hide cigarette_smoke
                with dissolve
                ...
                if day4_with_skin :
                    ...
                    scene sanatorium skin dormitory room at bg_fullscreen
                    with Fade(0.4, 0.5, 0.4, color="#000")
                    play music "audio/skin_music.mp3" fadein 2.0 fadeout 2.0 volume 0.18 noloop
                    show skin neutral at center
                    with dissolve
                    ...
                    "Хмыкнув, я скинул с себя верхнюю одежду и пошёл в душ. Давненько я не мылся, мне кажется от меня уже пованивать стало."
                    ...
                    "Он сделал ещё пару отжиманий и легко поднялся с пола."
                    skin "Ровно сто раз! Сейчас ещё десяточку пробегу, можно и на боковую"
                    sanya "Чего десяточку?"
                    skin "Километров конечно!"
                    "Он Сайтама, что ли?"
                    skin "Давай со мной? Прочищает мозги и чакры, спишь как убитый!"
                    "Ещё бы. После десяти-то километров."
                    ...
                    if day5_run_with_skin :
                        ...
                        scene sanatorium evening park at bg_fullscreen
                        with Fade(0.3, 0.5, 0.4, color="#000")
                        play sound "audio/footsteps_asphalt_loop.mp3" loop fadein 0.5 volume 0.25

                        "Выйдя на прохладный воздух, я с удовольствием его вдохнул. Иногда, всё-таки, приятно вот так выйти подышать. Жизнь не такой дерьмовой кажется."
                        show skin happy at right
                        with dissolve
                        skin "Ну, погнали"
                        ...
                        "Если размышлять трезво – всё, чем я занимаюсь сейчас, полнейший бред. Обычное прожигание времени. Ни саморазвития, ничего."
                        ...
                        "Я словно остался тем беззаботным ребёнком, которого ничего не волновало, который просто просыпался, чтобы весело провести время."
                        "Но ведь это неправильно – вечно быть этим ребёнком. Жизнь она более сложная и глубокая, она не ограничивается..."
                        "Да ничем она не ограничивается! Передо мной открыты все двери, у меня в моём возрасте тысяча возможностей для роста."
                        ...
                        "Я не могу. Начать просто – закончить ещё проще. Поддерживать процесс – не в моих силах. Не в моих силах просыпаться каждый день."
                        ...
                        "Тем же слабохарактерным уёбком в скорлупе, из которой не выбраться."
                        "Я могу сколько угодно размышлять по ночам о том, как я буду крут и успешен в будущем. Я могу сколько угодно мечтать о том, как буду выполнять свои цели."
                        ...
                        "Мои попытки – это жалкие капли воды. Но вода всё же может победить камень, хоть для этого и требует много времени."
                        ...
                        sanya "По-моёму, это какой-то бред. Я сейчас чувствую себя в комфорте, в принципе. Мне норм, я не страдаю."
                        ...
                        sanya "Как это вообще относится к мотивации?"
                        ...
                        sanya "Ты заебал, когда ты превратился в ебаного Угвея. ещё че философского может спизданешь."
                        ...
                        skin "Но, брат, пойми, это работает не всегда и это слишком ненадежно. Если ты пойдешь таким путём, тебе нужна будет постоянная поддержка со стороны."
                        ...
                        sanya "Не очень..."
                        skin "А я из простых. Поэтому и занимаюсь спортом, чтобы сын был здоров. И ищу такую же девушку. Просто я нашёл свою цель..."
                        ...
                        hide skin
                        with dissolve
                        "Какой же он всё-таки странный. Но... Может быть он и прав. В конце-концов, вряд ли много людей моего возраста нашло свой смысл просыпаться по утрам."
                        "Некоторые до самой смерти плывут по течению. Просто постараюсь не опускать руки. Искать себя это и правда нормально."
                        play sound "audio/footsteps.mp3" noloop fadein 0.2 fadeout 0.2
                        scene sanatorium skin dormitory room at bg_fullscreen
                        with Fade(0.4, 0.5, 0.4, color="#000")

                        "С такими мыслями я пошёл спать. Думаю, этот день прошел неплохо."
                ...
                if not day5_run_with_skin :
                    ...
                    "Понятливо кивнув, он отстал. Я же плюхнулся в кровать, стараясь не думать ни О чём, лишь бы побыстрее уснуть. День, определенное, выдался очень дерьмовый..."
            ...
            "Решив подобным образом, я сам себе кивнул и пошёл в комнату."
            scene bg_day5_room at bg_fullscreen with dissolve
            yuli "Рада, что ты правильно расставил приоритеты."
            "Что за хуйня?"
            "На моей кровати развалилась Юля собственной персоной."
            show yuli disappointed with dissolve
            sanya "Что? Ты как сюда попала?"
            yuli "Через дверь"
            show yuli neutral with dissolve
            play music "audio/backwards_intro.mp3" fadein 1.0 fadeout 2.0 volume 0.5
            "Она невинно улыбнулась, легко поднявшись с кровати."
            yuli "Ты выбрал абсолютно правильный вариант развития отношений, Саша. Это самое лучшее решение в твоей жизни. Твоему одиночеству пришёл конец"
            ...
            show yuli shy with dissolve
            stop music
            yuli "Это будет твоей наградой..."
            play music "audio/backwards_main.mp3" fadein 1.0 fadeout 2.0 volume 0.6
            show layer master at tv_noise
            "Меня настигло чувство невероятной эйфории. Хотелось смеяться, плакать, кричать от злости и верещать от восторга."
            show layer screens at tv_noise
            "И всё это одновременно. Этот убойный коктейль из эмоций был подобен удару пыльным мешком по голове – неожиданно."
            "Сбивающе с толку. Перед глазами завертелись цветные круши и неясные образы женского тела."
            show layer master at tv_noise(strength=0.8, grain_px=1.0, speed=3.0, line_int=0.6, warp=0.022, color=0.90)
        ...
        sanya "Ну, так... "
        extend "Я нашёл, чем себя занять..."
...
label _day6 :
    ...
    scene black 
    stop sound fadeout 2.0
    play music "audio/lobby_music.mp3" fadein 5.0 fadeout 2.5 volume 1.2
    play sound "audio/typewriter-sound.mp3" volume 0.5 loop
    ...
    scene black with Fade(2.0, 2.0, 5.0)
    jump _end

label _end :
    centered "{size=+24}Над проектом работали:\n{color=#3B7}Asind, DarlingInSteam\nDanilka108, Xpomin\nTheNorth, ArtsBer\nJuravl, rero{/color}{/size}"
