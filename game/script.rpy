...
label _sanatorium :
    ...
    "Все было достаточно светлым, но каким-то устаревшим что ли... Или просто очень дешевым."
    ...
    if day4_move == True:
        ...
        sanya "Да обычный вроде. Чампан вишневый."
        ...
        pavel "Меня Пал Геныч, будем знакомы."
        ...
        menu:
            "Отметим":
                ...
                "Придя в номер, мы стали накрывать поляну. Павел Геннадьевич достал из своей сумки курочку, бережно завернутую в фольгу."
            ...
            "Да ну его":
                $ day4_drink = False
                $ str_for_notification = "Это действи имеет последствия..."
                show screen notification_popup_big
                with dissolve
