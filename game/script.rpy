    ...
    if day4_take_pill:
        ...
        if day4_yuli_meal:
            ...
            if day4_siggaret_or_room :
                ...
                "Павла Геннадьевича не было, что немного меня порадовало. Видеть никого не хотелось. Пройдя на балкон, я упад в кресло и достал последнюю сигарету чапы."
                ...
                "О звездах не помнят. Звезды видят и они кажутся живыми. Человек жив, пока его видит и его видят. А воспоминания о нем..."
                ...
                if day4_suicide :
                    ...
                    noname "КТО НА БАЛКОНЕ В НЕПОЛОЖЕНОЕ ВРЕМЯ КУРИТ?!"
        ...
        show yuli empty glitch at truecenter:
            zoom 1.4
            ypos 0.7
        with dissolve 
