    ...
    if day5_nadya_in_cafe :
        ...
        if not day5_look_for_yuli :
            ...
            if day5_go_look_for_emilia :
                ...
                "Через время из-за двери появилась только её рука, схватила меня и понесла внутрь комнаты."
                ...
                "Её комната была с большой кроватью и на вид выглядела обставленной. Видимо, по платной путёвке предоставляют такие апартаменты."
                ...
                if day5_kiss_emilia :
                    ...
                    if day5_help_emily_panic :
                        ...
                        scene dream emily_1 at cover_full, tv_noise(strength=0.3, grain_px=3.0, speed=2.0, line_int=0.5, warp=0.007, color=0.50) with fade
                        "Там, в окружении кучи людей, в огромной лужи крови лежала сломанной куклой Эмилия."
                        scene dream emily_2 at cover_full, tv_noise(strength=0.4, grain_px=2.0, speed=3.0, line_int=0.4, warp=0.012, color=0.70) with fade
                        ...
                        show dream emily_foreground at center, tv_noise(strength=0.5, grain_px=1.0, speed=3.0, line_int=0.3, warp=0.022, color=0.90) with fade
                ...
                if day4_with_skin :
                    ...
                    if day5_run_with_skin :
                        ...
                        "Я не могу. Начать просто – закончить ещё проще. Поддерживать процесс – не в моих силах. Не в моих силах проспаться каждый день."
