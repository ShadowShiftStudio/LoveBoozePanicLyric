...
label first_day:
    ...
    if kfc_with_pasha :
        ...
        play music "audio/deadline_music.mp3" volume 0.67
...
label second_day :
    ...
    "Возле деканата меня повергла в шок необычайно длинная очередь. Видимо перваши пришли брать допуск на пересдачу."
    ...
    if go_to_smooking :
        ...
        if ussr_or_no :
            ...
            "Одногруппник" "Пхахаха, ты что в атомик харт переиграл, долбоебина (возможно заменить)? Давай-ка мы национализируем твои денюжки, пионер."
            "Они накинулись на меня толпой, противостоять им я никак не мог."
            "Кое-как отбрыкавшись, я направился в сторону универа."
            "Состояние у меня было хуже не куда, хотелось просто уйти как можно дальше от этого мира."
            "Не ожидал я от них такого, да и что плохого в СССР, чего только стоит советское мороженное."
            ...
            sanya "Не хочешь ко мне зайти, можем посмотреть кино или заняться чем-нибудь поинтереснее?"
            ...
            yuli "Прости, Саш. Мама уже зовёт домой, сегодня не получится уже поздновато"
            ...
            "Мне кажется я зря так отозвался о СССР, на деле я так не думаю. Не смотря на перестройку, жизнь в то время была куда лучше чем сейчас, люди добрее, трава зеленее."
            "Да и чего стоит советское мороженное и квас в бочках!"
            ...
            yuli "Саааш, привет. Как у тебя дела? Выглядишь немного грустным."
            ...
            yuli "Потому что нужно почаще выходить на улицу и побольше общаться с соб... Кхм, людьми."
            sanya_with_surname "Да... Наверно, ты права."
            "Может пригласить её куда-нибудь."
            sanya_with_surname "Не хочешь ко мне зайти, можем посмотреть кино или заняться чем-нибудь поинтереснее?"
    ...
    $ ussr_or_no = True
        ...
        "А ведь только утром покупал. Может кто спиздил?"
        "Ладно, в этот раз пойду пешком до дома. Сэкономлю хотя бы на проезде."

        scene black scen
        with fade

        "Пройдя пару кварталов, я заметил вход в парк, который находится не далеко от моего дома, чем не отличное место, чтобы привести мысли в порядок?"
        ...
        "Развернувшись девушка увидела меня и попросила пойти с ней ненадолго."
        scene red white
        with fade
        show nadya flirting
        with dissolve
        ...
        if buy_sigarets :
            ...
            nadya "Аа, вспомнила, ты был вчера на лекции по лингвистики, тебя ещё препод выгнал."
    ...
    if give_sigaret_nadya == False and buy_sigarets == False and go_to_smooking == False:
        ...
        "Я всю жизнь хотел посетить Артек, но так ни разу не смог туда попасть, путевки очень дорогие, а пробраться через заслуги в учебе для меня было невозможно."
        ...
        if choice_nadya_without_yuli :
            ...
            "А по ночам проводить оздоровительные процедуры по улучшению кровообращения в области таза."
...
label third_day :
    ...
    if last_choise_lonly :
        ...
        sanya_with_surname "Не знаю... может что-то с легкими? Я так понял ту куришь много..."
        ...
        if kfc_with_pasha == True :
            yuli "Приветик! Хоть здесь ты побудешь без своего Паши-алкаши"
            show yuli sad
            with dissolve
            ...
            yuli "Да ладно тебе, нужен тебе этот кочка-чочек!"
            sanya_with_surname "Паша мне очень помогал в жизни, иногда как прихватит - так только его шутка в себя приведет."
        ...
        if kfc_with_pasha == False and ussr_or_no == True :
            ...
            menu :
                "Определенно да, кстати, у меня сейчас как раз не лучшее настроение - не выспался совсем! Попробуем?" :

                    play music "audio/sigma.mp3" volume 0.1
                    pause 5.0
                    stop music
        ...
        if kfc_with_pasha == False and ussr_or_no == True :
            yuli "Давай! Я лягу на твое плечо"
        else :
...
label nadya_ch :
    ...
    if mood_counter == -10 :
        ...
        "Но мы с Надей молча ехали дальше. В глубокой и тяжёлой тишиной между нами."
    ...
    nadya "Всем приветики. Меня зовут Надя, парни, вот вам факт: ко мне не приставать! У меня есть уже кое кто на примете!!"

    "У нее все это время кто-то был? Ахуеть конечно, я думал у меня есть шанс"
    ...
    "Бля бля бля, надо придумать че я-то говорить буду. Так-с ебана, сейчас подумаю......"
    ...
    if mood_counter == -10 :
        ...
        "Мне резко стало плохо, головка закружилась, грудь сковала жгучая боль."
        ...
        "Медик" "Держись, парень. Сейчас мы тебя подлечем."
        ...
        "Краем глаза я увидел Надю, вскачившую со скамейк и бежавшую ко мне со слезами на глазах."
...
label yuli_sh :
    ...
    if mood_counter == -10 :
        ...
        "Все в автобусе оживленно разговаривали друг с другом."
        "Некоторые пристально смотрят в окно, разглядывая встречающиеся пейзажи."
        "Но мы с Юлей молча ехали дальше. В глубокой и тяжёлой тишиной между нами."
        "Я время от времени разглядывал пейзажи за окном, весело болтающих ребят."
        "Немного погодя меня и самого стало клонить в сон. "
        "Я не сопротивлялся."
    ...
    yuli "Всем приветики. Меня зовут Юля, парни, вот вам факт: ко мне не приставать! У меня есть уже кое кто на примете!!"
    ...
    if mood_counter == -10 :
        ...
        "Голова начала ужасно кружиться, я потерял ориентацию в пространстве."
        "Ноги начали подкашиваться, тело было готово рухнуть на тротуар, выложенный советской плиткой."
        "Краем глаза я увидел Юлю, вскачившую со скамейк и бежавшую ко мне со слезами на глазах."
        "Она взяла мою голову в свои маленькие ручки."
        ...
        sanya_with_surname "Прости меня, Юль, со мной все будет хорошо, " 
        extend "я всегда буду с тобой..."
...
label end_game :
    ...
    "Участие принимали: Asind, DarlingInSteam, Danilka108, Xpomin, TheNorth"
    "Asind - Мини-игры, арты, музыка, диалоги первого дня."
    "DarlingInSteam - Преобразование сценария в код, арты, музыка, диалоги второго дня."
    "Danilka108 - Мини-игры, работа с нейросетью, покушал."
    "Xpomin - Собрал шкаф, собрал компьютер, сценарий, диалоги."
    "TheNorth - Сценарий, диалоги."
    "В разделе \"Об игре\" можно найти ссылку на репозиторий GitHub"
    "Спасибо за прохождение данной новеллы. Мы благодарны за внимание."
=======
...
label end_game :
    centered "{size=+24}Участие принимали: Asind, DarlingInSteam, Danilka108, Xpomin, TheNorth"
