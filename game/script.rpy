...
label nadya_ch :
    ...
    "Сопровождающая" "Ребята, я очень рада, что все вы здесь, в нашем прекрасном санатории <HuiVOrtu>"
...
label alone_sh :
    ...
    play music "audio/sound-in-bus.mp3" fadein 1.5 fadeout 2.0 volume 0.
