...
label _day5 :
    ...
    if day5_nadya_in_cafe :
        ...
        if day5_nadya_date :
            ...
            "На самом деле мне были совершенно побоку все эти эпохи Ренессанса, барокко и прочих Возрождений, мне просто нравилось смотреть на неё, когда она вот так с жаром говорит о чем-то. "
            ...
            # концовка
                ...
                "Какая же она все-таки странная, а раньше казалась идеальной."
                ...
                extend "Хотелось просто прекратить эту боль."
