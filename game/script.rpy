...
label second_day :
    ...
    if go_to_smooking :
        ...
        "Стоявший справа от меня парень с неодобрительным взглядом протянул мне сижку шоколадного чапмана. Сделав пару затяг, мне приятно ударило по горлу, а никотин немного меня расслабил."
        ...
        if ussr_or_no :
            ...
            yuli "Ура, я не одна еду в санаторий, мы отлично проведем время вместе!"
            ...
            sanya_with_surname "Не хочешь ко мне зайти, можем посмотреть кино или чем-то ещё заняться?"
            "После этих слов у Юли зазвонил телефон."

            show yuli horny2
            with dissolve

            yuli "Прости, Саш. Мама уже зовёт домой, сегодня не никак получится."
...
label alone_sh :
    ...
    "Всё, что мне оставалось, - это молча смотреть в окно и наблюдать на проезжающие леса, дома, ИКАРУС????"
    window hide
    play sound "diskoteka_avaria.mp3"
    $ renpy.pause(1, hard=True)

    play music "audio/seven-summer.mp3" fadein 1.5 fadeout 1.5 volume 0.2
    
    centered "{size=+24}Автобус попал в аварию. Погибло два человека. Единственный Пассажир и водитель."
    $ renpy.pause(1, hard=True)
    stop sound
    jump end_game
...
label end_game :
    ...
    centered "{size=+24}Asind - Мини-игры, арты, музыка, диалоги первого дня."
    centered "{size=+24}DarlingInSteam - Преобразование сценария в код, арты, музыка, диалоги второго дня."
    centered "{size=+24}Danilka108 - Мини-игры, работа с нейросетью, покушал."
    centered "{size=+24}TheNorth - Сценарий, диалоги."
    centered "{size=+24}Xpomin - Собрал шкаф, собрал компьютер, сценарий, диалоги."
    centered "{size=+24}В разделе \"Об игре\" можно найти ссылку на репозиторий GitHub"
    centered "{size=+24}Спасибо за прохождение данной новеллы. Мы благодарны за внимание."