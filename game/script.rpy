...
label first_day:
    ...
    if renpy.mobile:
        ...
        centered "{size=+24}Используйте стрелочки вверх-вниз или клавиши W, A{/size}" 
    window hide
    call screen busday1
...
label second_day :
    ...
    centered "{size=+24}Найдите раскиданные справки за 8 секунд.\nНажмите ЛКМ, чтобы начать.{/size}"
...
label _day6 :
    ...
    centered "{size=+30}{color=#374}Конец первой главы.{/color}{/size}"
    jump _end
