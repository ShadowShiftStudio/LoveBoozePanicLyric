...
label _day5 :
    ...
    if day4_nadya_meal or day4_go_with_emili :
        "В столовой было немноголюдно. Видимо, ещё рановато для общего завтрака, но так лаже лучше. Посидеть в тишине всегда комфортнее, чем толкаться в очереди. "
        ...
        "К моей радости, в столовой уже сидела ["Эмилия и " if day4_met_emily] Надя, но Юли все ещё не было видно. Ладно... К кому бы сесть? "
    ...
    if day5_nadya_in_cafe :
        ...
        "Она резко встала, загремев стулом и пошла сдавать грязную посуду. Проводив взглядом её обтянутые джинсами бедра, я сам встал из-за стола."
