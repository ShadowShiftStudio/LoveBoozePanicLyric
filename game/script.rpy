...
label second_day :
    ...
    if go_to_smooking :
        ...
        nadya "Слушай, не мог бы ты купить мне чапу ванильного? Я забыла паспорт, а кассир ни в какую не продаёт. Меня, если что, Надя зовут."
        ...
        if buy_sigarets :
            ...
            sanya_with_surname "Добрый вечер, пару пачек ванильного чапмена."
