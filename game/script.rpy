...
label nadya_ch :
    ...
    if mood_counter == -10 :
        ...
        "Все в автобусе оживленно разговаривали друг с другом."
        "Некоторые пристально смотрят в окно, разглядывая встречающиеся пейзажи."
        "Спустя полчаса Надю стало клонить в сон, она опустила голову мне на плече и спокойно посапывала. "
...
label yuli_sh :
    ...
    if mood_counter == -10 :
        ...
        "Все в автобусе оживленно разговаривали друг с другом."
        "Некоторые пристально смотрят в окно, разглядывая встречающиеся пейзажи."
        "Спустя полчаса Юлю стало клонить в сон, она опустила голову мне на плече и спокойно посапывала. "
...
label end_game :
    ...
    "Asind - Мини-игры, арты, музыка, диалоги."
    "DarlingInSteam - Преобразование сценария в код, арты, музыка."
