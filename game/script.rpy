...
label first_day:
    ...
    "С другой стороны, сколько я уже пил с Пашей, а с девочкой погулять не приходить уже очень давно..."
...
label second_day :
    ...
    "Проезжая мимо старых домох и разбитых дорог, я поймал себя на мысли, что мой город либо статичен в своём развитии, либо я уже перестал видеть краски жизни..."
    ...
    if go_to_smooking :
        ...
        if ussr_or_no :
            ...
            "После этих слов мне пришлось отдать все деньги, которые были в карманах."
        ...
        if buy_sigarets :
            ...
            nadya "Большое спасибо, ты меня правда спас. Кстати говоря, меня Надя зовут, мне кажется мы уже где-то виделись."
        ...
        if buy_sigarets == True or give_sigaret_nadya == True :
            ...
            menu :
                ...
                "Нейтральный ответ" :
                    ...
                    sanya_with_surname "Прости, последнее время я очень занят, может когда-нибудь проще."
    ...
    if give_sigaret_nadya == False and buy_sigarets == False and go_to_smooking == False:
        ...
        "Мои мысли были только о Наде и нашей поездке."
