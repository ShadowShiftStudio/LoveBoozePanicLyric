...
label _sanatorium :
    ...
    olga_dmitrievna "Так, молодые люди, одно из правил санатория гласит, что курить можно только в строго отведенных местах, чтобы не мешать другим отдыхающим, – строго сказала она, – а лучше и вовсе не курить. Вы, как-никак, на лечение приехали!"
    ...
    "Старость, думал я, подступает незаметно. Как и всякая другая болезнь. Вот ты здоров, силен, молод и можешь выдуть чикушку за раз, а на утро выпить крепкого чаю и быть в строю."
    "А потом раз - и вот ты уже хрустишь коленками и боишься лишний раз наклониться, потому что темнеет в глазах. Так и с простудой: ходишь весь здоровый, чувствуешь себя прекрасно."
    ...
    if day4_move == True:
        ...
        if day4_smoke_after_words_olga :
            ...
            "Вот тут у нас проблемы, Ватсон! Бухнувшись на колени, я судорожно пытался вздохнуть, царапая пальцами плитку. Но мучился я не долго - висок взорвался болью и я потерял сознание. "
    ...
    if day4_take_pill:
        ...
        "Но это было ничто в сравнении с жгучей болю в растянутой бабочке."
        sanya "Добегался нахуй... Юль!"
        ...
        yuli "Саша?"
        yuli "СашаСашаСашаСашаСашаСашаСашаСашаСашаСашаСашаСашаСашаСашаСашаСашаСашаСашаСашаСашаСашаСашаСаша"
        sanya "кх-къх"
