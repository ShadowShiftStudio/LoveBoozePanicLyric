...
label second_day :
    ...
    extend "Ведь говорил же себе вчера купить пару пачек, но все равно забыл."
...
label _sanatorium :
    ...
    menu :
        ...
        "Сдержаться" :
            ...
            "Валерия Владимировна неодобрительно посмотрела на тех, кто ее проигнорировал и с вежливой улыбкой произнесла."
            valeria "А сейчас, давайте я вам проведу небольшую экскурсию, пока мы идем до ваших комнат."
    ...
    "Валерия Владимировна еще постояла, негодующим взглядом обжигая стойкую старушку, и в конце-концов сдалась, продолжив экскурсию."
    ...
    "Я стал больше прислушиваться к болтовне Валерии Владимировной, но усталость и голод брали свое."
    ...
    extend "Этот абориген будет моим соседом?!"
    ...
    if day4_move == True:
        ...
        if day4_smoke_after_words_valeria :
            ...
            "Посветив мне фонариком в глаза, и поводим им же перед носом, Агриппина Филипповна (а это была именно она, я ее хорошо запомнил) осталась довольна осмотром. "
            ...
            grusha "Ну так и иди нахуй отсюда!"
            ...
            menu :
                "Жестко вспомнить предков" :
                    ...
                    sanya "Вы кто? Где я?"
                    grusha "Я Агриппина Филипповна, твой ангел хранитель на случай, если опять будешь принимать сомнительные вещества. А находишься ты в раю, где ставят на ноги таких как ты"
                    sanya "А-а-а"
    ...
    if day4_take_pill:
        ...
        if day4_yuli_meal:
            ...
            extend "Пошел к корпусу, надеясь встретить ее по пути. "
            ...
            if day4_siggaret_or_room:
                ...
                menu :
                    ...
                    "Мне одиноко. Быть может, она составит мне компанию?" :
                        ...
                        extend "Настроение возвратилось в норму, курить совсем-совсем не хотелось."
                ...
                extend "Возможно, некоторые из них умерли тысячелетия назад, а мы все еще их видим, думаем о них."
...
label _day5 :
    ...
    if day4_nadya_meal or day4_go_with_emili :
        "В столовой было немноголюдно. Видимо, еще рановато для общего завтрака, но так лаже лучше. Посидеть в тишине всегда комфортнее, чем толкаться в очереди. "
        "Подойдя к раздаче, я оценил сегодняшнее меню. "
        "Молочный суп, сырники со сгущенкой и кофейный напиток. Как в лагере, честное слово. Взяв свою порцию, я огляделся выбирая куда сесть. "
        "К моей радости, в столовой уже сидела ["Эмилия и " if day4_met_emily] Надя, но Юли все еще не было видно. Ладно... К кому бы сесть? "
    ...
    if day5_nadya_in_cafe :
        ...
        sanya "Привет!"
        "Издали помахал ей рукой. Она махнула, в ответ, почти не подняв лица от тарелки."
        "Поставив ей на стол поднос с едой, я поинтересовался:"
        "sanya \"Как дела?\""
        "Девушка прожевала, посмотрела на меня и выдала:"
        nadya "Когда я ем - я глух и нем! Так что извини, но я не люблю болтать за столом"
        "С этими словами она закинула себе в рот новую порцию молочного супа и принялась активно жевать."
        "Что ж... Справившись с оторопью, я пожал плечами. Мало ли какие у людей причуды бывают. "
        ...
        nadya "Давай, почему бы и нет, все равно по вечерам тут делать нечего"
        sanya "Ну, старики играют в шашки и шахматы по беседкам, им есть чем заняться"
        "Надя лишь фыркнула. "
        nadya "Я думала тут веселее будет, когда ты меня приглашал. А тут вон как..." 
        sanya "Раз я тебя пригласил, мне тебя и развлекать"
        "Я поиграл бровями, заставив Надю чуть смутиться. "
        nadya "Что ж... Надеюсь, на твою помощь. Вечером в нашей беседке!"
        "Она резко встала, загремев стулом и пошла сдавать грязную посуду. Проводив взглядом ее обтянутые джинсами бедра, я сам встал из-за стола. "
