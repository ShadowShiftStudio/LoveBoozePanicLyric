...
label _sanatorium :
    ...
    "Валерия Владимировна бодро шла вперед, громко информируя нас о том, какой этот санаторий хороший и как качественно мы тут отдохнем. "
    ...
    "Вот ты здоров, силен, молод и можешь выдуть чекушку за раз, а на утро выпить крепкого чаю и быть в строю."
