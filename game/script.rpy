    ...
    if day5_nadya_in_cafe :
        ...
        menu:
            ...
            "Успокоить Юлю." :
                show yuli happy
                with dissolve
                yuli "Ур-а-а! Сашенька, куда пойдём?"
        ...
        if day5_nadya_date :
            ...
            show screen toska
            play sound "audio/heart.mp3" fadein 1.0 fadeout 2.0 volume 0.5
            ...
            "Мы сели на скамейку в курилке. Головокружение отпустило и в глазах прояснилось."
            ...
            "Мы спокойно общались на разные отвлеченные темы, вскоре и вовсе переместившись в парк. Решили, так сказать, размять ноги. "
            nadya "Я думаю, эпоха барокко снова возвращается к нам. Вся вот эта театральность, интерес к культуре смерти да и в целом некая мрачность появляется и сейчас."
            nadya "Раньше барокко считали чем-то низким, тем что нельзя, так сказать, упоминать. Любовь, эмоции на показ, все такое - сейчас же то же самое!"
            ...
            nadya "А ведь что самое главное? Главное то, что многие говорили что культура вырождается, население тупеет и прочее, прочее, прочее. А сейчас?"
            ...
            nadya "Саш?"
            "Голос Нади звучал словно через пелену. Голова кружилась, боль пульсировала в висках, подняв взгляд, я с трудом смог его сфокусировать."
            ...
            "Агриппина сидела около своей вотчины и попыхивая трубкой смотрела с задумчивым видом вдаль. "
            ...
            grusha "Ясно..."
            "До слуха донеслось какое-то копошение и в рот вдруг что-то вбрызнули. Что-то до жути горькое. "
            ...
            "На улице меня ждала обеспокоенная Надя. Увидев, что я выхожу на своих ногах, она сразу расцвела."
            ...
            sanya "Нет, но со мной такое впервые. Наверное, акклиматизация"
            nadya "Продолжим гулять или ты комнату пойдешь?"
            sanya "Конечно погуляем! Разве я могу терять шанс провести время с такой интересной и красивой девушкой?" 
            ...
            "Гулять в легкой одежде было можно, но и риск заболеть присутствовал. Именно из-за этого погуляли мы не очень долго, в конце-концов придя к корпусу. "
            "Остановившись около его входа, мы замерли в нерешительности. Расставаться не хотелось, но и продолжать дальше гулять на улице тоже. "
            ...
            menu :
                "Предложить пойти к Наде" :
                    if day4_nadya_meal :
                        ...
                        "Послышался шорох и шум, словно что-то передвигали. Через пару минут дверь открылась, и чуть растрепанная девушка впустила меня. "
                        ...
                        sanya "Давай"
                        "Помыв руки и умывшись, я пригладил свои вихрастые волосы. Ждать долго не пришлось, уже через пять минут Надя позвала меня. "
                        ...
                        sanya "Что?"
                        nadya "Что?"
                        "Тут она сделала такое невинное лицо, что я невольно рассмеялся. Через секунду к моему смеху присоединилась и Надя. "
                        nadya "Если хочешь... Можешь остаться у меня, соседняя кровать все равно не занята"
                        "Я замер, не веря своим ушам. Посмотрел на Надю, ожидая увидеть улыбку, но та была серьезной. "
            ...
            yuli "Замолчи! Я не хочу тебя видеть!"
            ...
            "Я постоял в ступоре пару секунд. Да... Такого у меня еще не было."
