init python:
    ...
    class Background():
        def __init__(self, speed, textures_index):
            self.image = Image(f"firstDays/mg1 road background{textures_index}.webm")
    ...
    class Road():
        def __init__(self, speed):
            self.image = Image("firstDays/mg1 road ground.webm")
        ...
        def __init__(self, speed, road):
            ...
            for _ in range(0, self.count_of_tracks - 1):
                ...
                if self.cars[pos] == None:
                    self.cars[pos] = Image(f"firstDays/car{random.randrange(1, 7)}.webm")
    ...
    class Bus():
        def __init__(self, speed, road, cars):
            self.road = road
            self.cars = cars
            self.image = Image("firstDays/bus top view.webm")
            self.prev_track_i = 1
            self.curr_track_i = 1
    ...
    class SurrenderBtn(renpy.Displayable):
        def __init__(self, on_click):
            ...
            self.image = Image("firstDays/surrender btn.webm")
