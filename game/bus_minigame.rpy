init python:
    ...
    class BusMinigameDisplayable(renpy.Displayable):
        ...
        def __init__(self, hi_score):
            ...
            self.cars_sets = [[2], [1, 0], [0, 2]]#, [2], [0, 1], [0, 2], [1], [1, 0], [2, 0], [2, 1], [1, 2], [], [0,2], [1], [2,0], [0], [1], [2], [0,2], [1,2], [], [0,1], [0,1], [1,2], [1,2], [0,1]]
            # TODO: СЛОМАЛ РАБОТУ ЛИНИЙ, ПИЗДЕЦ. ОНИ ТЕПЕРЬ ПОДРЯД ИДУТ ПОМОГИТЕ
